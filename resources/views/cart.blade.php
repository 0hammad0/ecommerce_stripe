                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="cart">
                            ...
                            <h1 class="cart-title">In Your Shopping Cart: <span class="c-primary"> {{ $carts->Count() }}
                                    items</span></h1>
                                        ...
                                        <tr class="cart_item">
                                            ...
                                            <td class="product-thumbnail">
                                                ...
                                                <div class="cart-product__item">
                                                    <a href="#">
                                                        <img src="app/img/cart-product4.png" alt="product"
                                                            class="attachment-shop_thumbnail size-shop_thumbnail wp-post-image">
                                                    </a>
                                                    <div class="cart-product-content">
                                                        <p class="cart-author">Callum Bailey</p>
                                                        <h5 class="cart-product-title">{{ $products->prod_name }}</h5>
                                                    </div>
                                                </div>
                                            </td>
